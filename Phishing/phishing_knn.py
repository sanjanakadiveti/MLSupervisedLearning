...
plt.figure()
title = 'Phishing KNN: Performance vs K-Value'
plt.title('\n'.join(wrap(title,60)))
...
print 'plotting results'
plt.figure()
title = 'Phishing KNN: Performance x Training Set Size'
plt.title('\n'.join(wrap(title,60)))
...
plt.ylabel('Accuracy')
plt.savefig('Phishing_KNN_TrainingSize.png', dpi=300)
print 'plot complete'
